...
<div class="row justify-content-center mt-5">
  <div class="col-lg-4">
    ...
    <main class="form-registration w-100 m-auto">
      <h1 class="h3 mb-3 fw-normal text-center fw-Medium">Registration Form</h1>
      ...
      <small class="d-block text-center mt-5">Already Register? <a href="/login">Login Now! </a></small>
    </main>
